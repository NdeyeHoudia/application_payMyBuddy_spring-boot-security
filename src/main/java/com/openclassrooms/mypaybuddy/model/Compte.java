...
public class Compte {
   ...
   public void depot(double montant) {
    ...
    public  void virement(double montant, Compte compteEmeteur, Compte comptRecepteur){
        compteEmeteur.solde-=montant;
        comptRecepteur.solde+=montant;
    }
   /* public void addTransaction(Transaction transaction) {
        transactionsSortantes.add(transaction);
        transaction.getComptes().add(this);
    }
    public void removeTransaction(Transaction transaction) {
        transactionsSortantes.remove(transaction);
